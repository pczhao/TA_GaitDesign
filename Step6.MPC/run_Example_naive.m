% Track a given speed sequence: naive method
...
% speed_high = 1.6;
K0_high = [ 1.5,   0.4 ];   % initial guess for fmincon, high speed
speed_high = 1.65;

speed_low = 0.3;
K0_low = [0.3, 0.1 ];   % initial guess for fmincon, low speed

ref_speed = [ repmat(speed_high, 4, 1); repmat( speed_low, 30, 1 )];
...
for nsteps = 1 : 15
    ...
    tic
    P = online_opt_naive(dth0,ref_speed(nsteps:nsteps+2),100,P0(nsteps,:)');
    toc
