function [x,y,z,info] = spot_sedumi(A,b,c,K,options)
    ...
    start = spot_now();
    param = [];
%     param.MSK_DPAR_INTPNT_CO_TOL_DFEAS = 1.0e-100;
%     param.MSK_DPAR_INTPNT_CO_TOL_MU_RED = 1.0e-100;
%     param.MSK_DPAR_INTPNT_CO_TOL_NEAR_REL = 1000000;
%     param.MSK_DPAR_INTPNT_CO_TOL_PFEAS = 1.0e-100;
%     param.MSK_DPAR_INTPNT_CO_TOL_REL_GAP = 1.0e-100;
